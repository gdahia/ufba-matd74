...
N\'os comparamos a heur\'istica proposta com duas outras heur\'isticas anteriores que tamb\'em
reportaram resultados para essas inst\^ancias~\cite{carrabs2013, melo2016}.

Para obter os resultados de cada inst\^ancia individualmente, recorremos ao arquivo Excel em formato
\textit{xlsx} disponibilizado pelos autores de um trabalho~\cite{carrabs2013}, e ao c\'odigo fonte
das tabelas de outro~\cite{melo2016}, obtidos atrav\'es da submiss\~ao do mesmo ao \textit{arXiv}\footnote{https://arxiv.org/e-print/1509.06562}. Parseamos os resultados de ambas tabelas usando a
biblioteca Pandas~\cite{pandas}.
